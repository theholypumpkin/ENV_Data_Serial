...
void setup()
{
    ...
    pinMode(CCS_811_INTERRUPT_PIN, OUTPUT); // TODO test this
    /*-   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   */
    setupEEPROM();
    /*-   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -   -
     ...
     * would never trigger.
     */
    digitalWrite(CCS_811_INTERRUPT_PIN, HIGH);
...
void loop()
{
    ...
    case READ_GP2Y_SENSOR:
        ...
        if (g_loopCount == 0)
        { // this will occur only after 60 readings ~1h
    ...
    default:
        ...
        // Serial.println(digitalRead(CCS_811_INTERRUPT_PIN) ? "HIGH" : "LOW");
        break;
    }
}
/*________________________________________________________________________________________________*/
